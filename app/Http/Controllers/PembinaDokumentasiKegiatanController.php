...
class PembinaDokumentasiKegiatanController extends Controller
{
    ...
    public function show(DokumentasiKegiatan $dokumentasi): Response
    {
        ...
        $organisasiId = $dokumentasi->kegiatan?->profilOrganisasi?->id_organisasi;
        ...
        return Inertia::render('pembina/dokumentasi-kegiatan-show', [
    ...
    public function updateStatus(Request $request, DokumentasiKegiatan $dokumentasi): RedirectResponse
    {
        ...
        return redirect()->route('pembina.dokumentasi-kegiatan.index');
    }
}
