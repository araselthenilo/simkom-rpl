...
class AdminLaporanController extends Controller
{
    public function index(): Response
    {
        ...
        $arsip = ArsipLaporan::with(['organisasi:id_organisasi,nama_organisasi', 'penggunaPetugas:username'])
    ...
    public function generate(Request $request): RedirectResponse
    {
        ...
        if ($jenisLaporan === 'Keuangan') {
            // Build query for TransaksiKeuangan matching admin filters
            ...
            // Kegiatan reports logic
            $query = Kegiatan::withCount('pesertaKegiatan')
