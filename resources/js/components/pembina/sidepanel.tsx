...
export default function Sidepanel() {
    ...
    const menuItems: NavItem[] = [
        { title: 'Dashboard', href: pembina.dashboard(), icon: LayoutDashboard },
        { title: 'Organisasi', href: pembina.organisasi(), icon: Building2 },
        { title: 'Pengurus', href: pembina.pengurus.index(), icon: Users },
        {
